...
<body>
		...
		<div class="col-lg-8">
			<table border="1">
				...
				<tr>
					...
					<th scope="row">&nbsp&nbsp Bloquear</th>
				</tr>
					<?php 
							...
							class conexion//clase conexion
							{
								...
								function tablaDeDatosDeUsuario()
								{
									...
									$query = "SELECT * from administrador";//consulta a base de datos
									...
									while($dato = mysqli_fetch_array($resultado))//Guardar y desplegar los resultados en un arreglo
									{
										...
										<tr class="table-secondary">
											<td><?php echo $dato['idAdministrador']; ?></td>
											<td>&nbsp&nbsp <?php echo $dato['nombreAdministrador']; ?></td>
											...
											<td><button type="button" class="btn btn-danger" onclick="confirmaEliminar(<?php echo $dato['idAdministrador']; ?>)">Eliminar</button>
											</td>
										</tr>
	...
	<script type="text/javascript">
		...
		function confirmaEliminar(idAdmin)
	 	{
	 		if(confirm('¿Esta seguro que desea eliminar la pelicula con el id '+idAdmin+' ?'))
	 		{
	 			window.location.href = "eliminaAdmin.php?idAdministrador=" + idAdmin;
	 		}
